...
SAFETY_FIELDS: dict[str, FieldSpec] = {
    ...
    "drugs": FieldSpec(
        "drugs", "closed", taxonomy="drugs", value_field="drugsFuzzy",
        fuzzy_wildcard=True, facetable=True, display_column="drug",
    ),
    "effects": FieldSpec(
    ...
    "route": FieldSpec(
        "route", "closed", taxonomy="route", facetable=True, display_column="route",
    ),
    "toxicityParameter": FieldSpec(
        "toxicityParameter", "closed", taxonomy="toxicity_parameters",
        display_column="toxicityParameter",
    ),
    "documentSource": FieldSpec(
        "documentSource", "closed", taxonomy="sources", facetable=True,
        display_column="source",
    ),
    "doseType": FieldSpec(
        "doseType", "closed", taxonomy="dose_type", facetable=True, display_column="doseType",
    ),
    "documentYear": FieldSpec(
        "documentYear", "closed", taxonomy="document_year", facetable=True,
        display_column="documentYear",
    ),
    # closed-vocab but routed via a linked entity
    "indications": FieldSpec(
        "indications", "closed", taxonomy="indications", entity_name="DrugsIndications",
    ),
