...
class LLMDecomposer:
    ...
    def _build_prompt(self, query: str, service: ServiceConfig) -> str:
        ...
        return (
            ...
            "reported over the results. The grammatical subject the question asks for is a "
            "QUESTION, not a filter: in 'What are the <X> [found] for/of/in ...', 'which "
            "<X> ...', 'at which <X> ...', the <X> (adverse events, drugs, dose, route, "
            "dosing regimen) is the reported output. The constraints are the other clauses "
            "(the drug/species/route/indication the results are restricted to). E.g. 'What "
            "are the adverse events of Sunitinib in human' -> effects is a QUESTION; "
            "Sunitinib and human are filters.\n"
